...
sprites_dat_t::sprites_dat_t(uint16_t p_num_lines, kaitai::kstream* p__io, kaitai::kstruct* p__parent, sprites_dat_t* p__root) : kaitai::kstruct(p__io) {
    m__parent = p__parent;
    m__root = this;
...
void sprites_dat_t::_read() {
    ...
    n_select_circle_image_size = true;
    if (1 == 2) {
        n_select_circle_image_size = false;
    ...
    n_select_circle_vertical_pos = true;
    if (1 == 2) {
        n_select_circle_vertical_pos = false;
