...
--  StartAttack = {"frame 0", "wait 1", "frame 17", "wait 1", "frame 34",},
  Attack = {
    "wait 1", "unbreakable begin", "attack",
    "frame 17", "wait 1", "frame 34", "wait 1", "frame 51", "wait 1",
    "frame 68", "wait 1", "frame 51", "wait 1", "frame 34",
    "unbreakable end", "wait 1", "frame 17",
  },
--  EndAttack = {"frame 17", "wait 1", "frame 0", "wait 1", --[[goto 70FD]]},
  Death = {
    "unbreakable begin",
    --[["sound zerg-zergling-death",--]] "exact-frame 221", "wait 2",
