DefineAnimations("animations-zerg-mut", {
  Still = {"frame 0", "wait 2", "frame 17", "wait 2", "frame 34", "wait 2", "frame 52", "wait 2", "frame 62"},
  Move = {"unbreakable begin", "frame 0", "move 3", "wait 2", "frame 17", "move 3", "wait 1",
    "frame 34", "move 3", "wait 2", "frame 52", "move 2", "wait 1",
    "frame 62", "move 3", "wait 1", "frame 0", "move 2", "wait 1",
    "frame 17", "move 3", "wait 2", "frame 34", "move 3", "wait 1",
    "frame 52", "move 3", "wait 2", "frame 62", "move 2", "wait 1",
    "frame 0", "move 3", "wait 1", "frame 17", "move 2", "unbreakable end", "wait 4",},
...
DefineUnitType("unit-zerg-mut", { Name = "Mutalisk",
