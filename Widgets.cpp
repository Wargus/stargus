...
bool Widgets::convert(const char *mpqfile, const char* arcfile, const char* file, int pale)
{
...
void Widgets::SaveImage(char *name, unsigned char *image, unsigned char *palp, int id, int w, int h)
{
...
void Widgets::SaveButton(char *name, unsigned char *image, unsigned char *palp, int size, int id)
{
